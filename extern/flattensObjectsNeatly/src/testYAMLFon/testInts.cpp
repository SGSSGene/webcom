...
TEST_CASE("test yaml serialization of int8_t", "[yaml][int8_t][serialize]") {
    ...
    SECTION("min number") {
        ...
        auto node = fon::yaml::serialize(data);
        REQUIRE(node.IsScalar());
        REQUIRE(node.as<int16_t>() == -128);
    }

}

TEST_CASE("test yaml deserialization of int8_t", "[yaml][int8_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
...
TEST_CASE("test yaml serialization of uint8_t", "[yaml][uint8_t][serialize]") {
    SECTION("positive number") {
    ...
    SECTION("min number") {
        ...
        auto node = fon::yaml::serialize(data);
        REQUIRE(node.IsScalar());
        REQUIRE(node.as<uint16_t>() == 0);
    }
}

TEST_CASE("test yaml deserialization of uint8_t", "[yaml][uint8_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
        node = 7; // "random" number
...
TEST_CASE("test yaml serialization of int16_t", "[yaml][int16_t][serialize]") {
    SECTION("positive number") {
...
TEST_CASE("test yaml deserialization of int16_t", "[yaml][int16_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
        node = 7; // "random" number
...
TEST_CASE("test yaml serialization of uint16_t", "[yaml][uint16_t][serialize]") {
    SECTION("positive number") {
...
TEST_CASE("test yaml deserialization of uint16_t", "[yaml][uint16_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
        node = 7; // "random" number
...
TEST_CASE("test yaml serialization of int32_t", "[yaml][int32_t][serialize]") {
    SECTION("positive number") {
...
TEST_CASE("test yaml deserialization of int32_t", "[yaml][int32_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
        node = 7; // "random" number
...
TEST_CASE("test yaml serialization of uint32_t", "[yaml][uint32_t][serialize]") {
    SECTION("positive number") {
...
TEST_CASE("test yaml deserialization of uint32_t", "[yaml][uint32_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
        node = 7; // "random" number
...
TEST_CASE("test yaml serialization of int64_t", "[yaml][int64_t][serialize]") {
    SECTION("positive number") {
...
TEST_CASE("test yaml deserialization of int64_t", "[yaml][int64_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
        node = 7; // "random" number
...
TEST_CASE("test yaml serialization of uint64_t", "[yaml][uint64_t][serialize]") {
    SECTION("positive number") {
...
TEST_CASE("test yaml deserialization of uint64_t", "[yaml][uint64_t][deserialize]") {
    SECTION("positive number") {
        YAML::Node node;
        node = 7; // "random" number
