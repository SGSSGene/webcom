...
TEST_CASE("test yaml serialization of std::string", "[yaml][std][string]") {
...
TEST_CASE("test yaml deserialization of std::string", "[yaml][std][string]") {
	YAML::Node node;
	node = "hallo welt";
...
TEST_CASE("test yaml serialization of std::vector", "[yaml][std][vector]") {
...
TEST_CASE("test yaml deserialization of std::vector", "[yaml][std][vector]") {
	YAML::Node node;
	node[0] = 10;
	node[1] = 20;
	node[2] = 30;
...
TEST_CASE("test yaml serialization of std::array", "[yaml][std][array]") {
...
TEST_CASE("test yaml deserialization of std::array", "[yaml][std][array]") {
	YAML::Node node;
	node[0] = 10;
	node[1] = 20;
	node[2] = 30;
...
TEST_CASE("test yaml serialization of std::list", "[yaml][std][list]") {
...
TEST_CASE("test yaml deserialization of std::list", "[yaml][std][list]") {
	YAML::Node node;
	node[0] = 10;
	node[1] = 20;
	node[2] = 30;
...
TEST_CASE("test yaml serialization of std::forward_list", "[yaml][std][forward_list]") {
...
TEST_CASE("test yaml deserialization of std::forward_list", "[yaml][std][forward_list]") {
	YAML::Node node;
	node[0] = 10;
	node[1] = 20;
	node[2] = 30;
...
TEST_CASE("test yaml serialization of std::deque", "[yaml][std][deque]") {
...
TEST_CASE("test yaml deserialization of std::deque", "[yaml][std][deque]") {
	YAML::Node node;
	node[0] = 10;
	node[1] = 20;
	node[2] = 30;
...
TEST_CASE("test yaml serialization of std::set", "[yaml][std][set]") {
...
TEST_CASE("test yaml deserialization of std::set", "[yaml][std][set]") {
	YAML::Node node;
	node[0] = 10;
	node[1] = 20;
	node[2] = 30;
...
TEST_CASE("test yaml serialization of std::unordered_set", "[yaml][std][unordered_set]") {
...
TEST_CASE("test yaml deserialization of std::unordered_set", "[yaml][std][unordered_set]") {
	YAML::Node node;
	node[0] = 10;
	node[1] = 20;
	node[2] = 30;
...
TEST_CASE("test yaml serialization of std::map", "[yaml][std][map]") {
...
TEST_CASE("test yaml deserialization of std::map", "[yaml][std][map]") {
	YAML::Node node;
	node["k1"] = 10;
	node["k2"] = 20;
	node["k3"] = 30;
...
TEST_CASE("test yaml serialization of std::unordered_map", "[yaml][std][unordered_map]") {
...
TEST_CASE("test yaml deserialization of std::unordered_map", "[yaml][std][unordered_map]") {
	YAML::Node node;
	node["k1"] = 10;
	node["k2"] = 20;
	node["k3"] = 30;
...
TEST_CASE("test yaml serialization of std::pair", "[yaml][std][pair]") {
...
TEST_CASE("test yaml deserialization of std::pair", "[yaml][std][pair]") {
	YAML::Node node;
	node[0] = "hallo welt";
	node[1] = 42;
...
TEST_CASE("test yaml serialization of std::tuple<>", "[yaml][std][tuple]") {
	auto data = std::tuple<>{};
	auto node = fon::yaml::serialize(data);
	REQUIRE(node.size() == 0);
}
...
TEST_CASE("test yaml serialization of std::tuple<X>", "[yaml][std][tuple]") {
...
TEST_CASE("test yaml deserialization of std::tuple<X>", "[yaml][std][tuple]") {
	YAML::Node node;
	node[0] = "hallo welt";
...
TEST_CASE("test yaml serialization of std::tuple<X, Y>", "[yaml][std][tuple]") {
...
TEST_CASE("test yaml deserialization of std::tuple<X, Y>", "[yaml][std][tuple]") {
	YAML::Node node;
	node[0] = "hallo welt";
	node[1] = 42;
	REQUIRE(node.IsSequence());
...
TEST_CASE("test yaml serialization of std::optional", "[yaml][std][optional]") {
...
TEST_CASE("test yaml deserialization of std::optional", "[yaml][std][optional]") {
	YAML::Node node;
	node[0] = "hallo welt";
...
TEST_CASE("test yaml serialization of empty std::optional", "[yaml][std][optional]") {
	auto data = std::optional<std::string>{};
	auto node = fon::yaml::serialize(data);
	REQUIRE(node.size() == 0);
}
TEST_CASE("test yaml deserialization of empty std::optional", "[yaml][std][optional]") {
	YAML::Node node;
	auto data = fon::yaml::deserialize<std::optional<std::string>>(node);
	REQUIRE(not data.has_value());
}

TEST_CASE("test yaml serialization of std::variant (index 0)", "[yaml][std][variant]") {
...
TEST_CASE("test yaml deserialization of std::variant (index 0)", "[yaml][std][variant]") {
...
TEST_CASE("test yaml serialization of std::variant (index 1)", "[yaml][std][variant]") {
...
TEST_CASE("test yaml deserialization of std::variant (index 1)", "[yaml][std][variant]") {
	YAML::Node node {YAML::NodeType::Map};
	node[1] = 42;
	auto data = fon::yaml::deserialize<std::variant<std::string, int32_t, bool>>(node);
...
TEST_CASE("test yaml serialization of std::variant (index 2)", "[yaml][std][variant]") {
...
TEST_CASE("test yaml deserialization of std::variant (index 2)", "[yaml][std][variant]") {
	YAML::Node node {YAML::NodeType::Map};
	node[2] = true;
	auto data = fon::yaml::deserialize<std::variant<std::string, int32_t, bool>>(node);
...
TEST_CASE("test yaml serialization of std::filesystem::path", "[yaml][std][filesystem][path]") {
...
TEST_CASE("test yaml deserialization of std::filesystem::path", "[yaml][std][filesystem][path]") {
	YAML::Node node;
	node = "./some_file";
...
TEST_CASE("test yaml serialization of std::set<std::filesystem::path>", "[yaml][std][filesystem][set][path]") {
...
TEST_CASE("test yaml deserialization of std::set<std::filesystem::path>", "[yaml][std][filesystem][set][path]") {
	YAML::Node node;
	node[0] = "./some_file";
...
TEST_CASE("test yaml serialization of std::chrono::time_point<ms>", "[yaml][std][chrono][time_point]") {
...
TEST_CASE("test yaml deserialization of std::chrono::time_point<ms>", "[yaml][std][chrono][time_point]") {
	YAML::Node node;
	node = 42;
...
TEST_CASE("test yaml serialization of std::chrono::time_point<ns>", "[yaml][std][chrono][time_point]") {
...
TEST_CASE("test yaml deserialization of std::chrono::time_point<ns>", "[yaml][std][chrono][time_point]") {
	YAML::Node node;
	node = 42;
...
TEST_CASE("test yaml serialization of std::filesystem::file_time_type", "[yaml][std][chrono][time_point]") {
...
TEST_CASE("test yaml deserialization of std::filesystem::file_time_type", "[yaml][std][chrono][time_point]") {
	YAML::Node node;
	node = 42;
